...
exports.ReplyFakeStatus = async function(deswita,to, text, prevtext, msgId="B826873620DD5947E683E3ABE663F263"){
    waid = "0@s.whatsapp.net"
    deswita.sendMessage(to, text, MessageType.text, {contextInfo: {'stanzaId': msgId, 'participant': waid, 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": prevtext, 'jpegThumbnail': fs.readFileSync('./media/deswita.jpg')}}}})
}
